...
$ModuleDir = Join-Path $ProjectRoot "InspectionBackend\car"
$LogDir = Join-Path $ScriptDir "logs"
if (-not (Test-Path $LogDir)) { New-Item -ItemType Directory -Force -Path $LogDir | Out-Null }

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  Car - 小车知识源" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
...
$jar = Join-Path $ModuleDir "target\car.jar"
...
Write-Host "[START] 启动 Car..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[STOP] Car 已停止" -ForegroundColor Yellow
Pause
