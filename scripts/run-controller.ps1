...
$ModuleDir = Join-Path $ProjectRoot "InspectionBackend\controller"
$LogDir = Join-Path $ScriptDir "logs"
if (-not (Test-Path $LogDir)) { New-Item -ItemType Directory -Force -Path $LogDir | Out-Null }

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  Controller - 节拍调度器" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
...
$jar = Join-Path $ModuleDir "target\controller.jar"
...
Write-Host "[START] 启动 Controller..." -ForegroundColor Green
...
Write-Host ""
Write-Host "[STOP] Controller 已停止" -ForegroundColor Yellow
Pause
